...
public class ClientModEvents {
    ...
    public static void register() {
        WorldRenderEvents.AFTER_TRANSLUCENT.register(context -> {
            ...
            // Таймер: удаляем блоки через 30 секунд (реальные мс)
            highlightedOres.entrySet().removeIf(entry -> currentTime - entry.getValue() > 30000);
            ...
            // НОВЫЙ СПОСОБ: begin возвращает BufferBuilder
