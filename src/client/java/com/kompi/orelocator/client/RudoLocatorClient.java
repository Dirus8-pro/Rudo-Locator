...
public class RudoLocatorClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(ModNetwork.ORE_HIGHLIGHT_PACKET, (client, handler, buf, responseSender) -> {
            OreHighlightPacket packet = OreHighlightPacket.decode(buf);
            client.execute(() -> {
                ClientModEvents.setHighlightedOres(packet.getOrePositions());
            });
        });
    }
}